...
namespace CommandAPI.Tests
{
    public class CommandsControllerTests : IDisposable
    {
        ...
        [Fact]
        public void PartialCommandUpdate_Returns404NotFound_WhenNoneExistentResourceIDSubmitted()
        {
            // Arrange
            mockRepo.Setup(repo =>
                repo.GetCommandById(0)).Returns(() => null);
        ...
        [Fact]
        public void DeleteCommand_Returns204NotContent_WhenValidResourceIDSubmitted()
        {
            // Arrange
            mockRepo.Setup(repo =>
                repo.GetCommandById(1)).Returns(new Command
